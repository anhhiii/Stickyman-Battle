...
class SettingsMenu:
    def __init__(self, screen):
        ...
        self.home_icon = pygame.image.load("assets/icons/home_icon.png")
        self.home_icon = pygame.transform.scale(self.home_icon, (50, 50))  # Resize icon Home (nhỏ hơn)

        self.volume_icon = pygame.image.load("assets/icons/volume_icon.png")
        self.volume_icon = pygame.transform.scale(self.volume_icon, (50, 50))  # Resize icon Volume (nhỏ hơn)

        self.back_icon = pygame.image.load("assets/icons/back_icon.png")
